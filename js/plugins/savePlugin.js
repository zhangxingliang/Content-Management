  ...
  var plugin = EditorPluginBase.extend({
    init: function(app) {
      ...
      _btnOk.addEventListener("click", function() {
        ...
        if (flag) {
          var url = _siteRoot + "renderPef";
          var par = {
            userToken: _userToken,
            siteCode: _siteCode,
            pefName: _inputTitle.value.trim()
          };
          ...
          $.ajax({
            ...
            success: function(r) {
              if (r.code == "0") {
                var url2 = _siteRoot + "sendToRender";
                ...
                var par2 = {
                  ...
                  siteCode: _siteCode,
                  PEFSourcePath: r.ext.pefFilePath,
                  entityName: _inputTitle.value.trim(),
              ...
              if (r.Code == "0") {
                if (!window.parent.editor.isCreating) {
                  if (r.Ext) {
                    ...
                    editor.edlPath = store.state.saveFolder.path; //_rootPath + _inputPath.value;
